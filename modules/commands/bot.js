...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "meri setting kahan hai") || (event.body.toLowerCase() == "meri gf kha hai")) {     return api.sendMessage("️️️Jaan Main Hoon Na Tumhari setting", threadID);
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "bot ka malik")) {
     return api.sendMessage("༻𝐎𝐖𝐍𝐄𝐑:- ☞ ༻☞[𝐎𝐖𝐍𝐄𝐑:☞➸⃝🐼⃝⃞⃟𝙠𝙝𝙖𝙣🎸  ☜ 𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝙠𝙝𝙖𝙣. ☜ ༺༒ ༒𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝༒:- https://www.facebook.com/.khansahab.345 ☞    his insta id @𝙆𝙃𝘼𝙉 ☜ ༺༒ ༒", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "tera admin kon hai") || (event.body.toLowerCase() == "bot ka admin kon hai")) {
     return api.sendMessage("My admin is 𝙠𝙝𝙖𝙣. He Gives his name mr Shaan everywhare", threadID);
   };
...
if ((event.body.toLowerCase() == "😍😍")) {return api.sendMessage("IS NAZAR SE KHAN KO DEKHO PYARA NA LAGY PAISE WAPIS 😝😂 ", threadID);
   };
